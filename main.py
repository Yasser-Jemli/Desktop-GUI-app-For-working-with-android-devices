...
output_text = ttk.Treeview(terminal_frame)
output_text.pack()
...
b1 = ttk.Button(button_frame_label, text=" list _ adb _devices + states ")
b1.grid(row=1 , column=0 ,padx=5, pady=5, sticky="nsew")
b2 = ttk.Button(button_frame_label , text=" list _ profiles ")
b2.grid(row=2 , column=0 ,padx=5, pady=5, sticky="nsew")
b3 = ttk.Button(button_frame_label, text=" Start Scrcpy ")
...
b5 = ttk.Button(button_frame_label, text=" Volume Up ")
b5.grid(row=5 , column=0 ,padx=5, pady=5, sticky="nsew")
b6 = ttk.Button(button_frame_label , text=" Volume Down ")
b6.grid(row=6 , column=0 ,padx=5, pady=5, sticky="nsew")
b7 = ttk.Button(button_frame_label, text="Clear Terminal")
